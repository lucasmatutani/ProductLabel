...
class Rule extends \Magento\CatalogRule\Model\Rule {
	...
	/**
	 * @var \Lof\ProductLabel\Plugin\App\Config\ScopeCodeResolver
	 */
	private $scopeCodeResolver;

	/**
	 * @var \Lof\ProductLabel\Helper\Stock
	 */
	private $stockHelper;
	...
	{
		$this->lofSerializer  = $this->getData( 'lofSerializer' );
		...
		if ( ! $this->lofSerializer ) {
			$this->lofSerializer = $this->serializer;
		}
		parent::_construct();
	 ...
	 * @return array|null
	 */
	public function getMatchingProductIdsByLabel( Label $label )
	{
	...
	{
		$resultCondition = $this->lofSerializer->unserialize( $conditions );
