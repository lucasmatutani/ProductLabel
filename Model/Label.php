 ...
 */
class Label extends AbstractLabel implements LabelInterface, IdentityInterface {
    /**
     * @var array
     */
    ...
    public function getCssClass()
    {
        ...
        $pos = $this->getValue( 'position' ) ? $this->getValue( 'position' ) : 0;
    ...
    {
        $this->setData( LabelInterface::PRIORITY, $priority );
    ...
    {
        return $this->_getData( LabelInterface::EXCLUSIVELY );
    }
    ...
    {
        $this->setData( LabelInterface::EXCLUSIVELY, $exclusively );
    ...
    {
        return $this->_getData( LabelInterface::PRODUCT_TYPE );
    }
    ...
    {
        $this->setData( LabelInterface::PRODUCT_TYPE, $prodType );
    ...
    {
        return $this->_getData( LabelInterface::PRODUCT_SHAPE );
    }
    ...
    {
        $this->setData( LabelInterface::PRODUCT_SHAPE, $prodShape );
    ...
    {
        return $this->_getData( LabelInterface::PRODUCT_LABEL_TEXT );
    }
    ...
    {
        $this->setData( LabelInterface::PRODUCT_LABEL_TEXT, $prodTxt );
    ...
    {
        return $this->_getData( LabelInterface::PRODUCT_IMG );
    }
    ...
    {
        $this->setData( LabelInterface::PRODUCT_IMG, $prodImg );
    ...
    {
        return $this->_getData( LabelInterface::PRODUCT_IMAGE_SIZE );
    }
    ...
    {
        $this->setData( LabelInterface::PRODUCT_IMAGE_SIZE, $prodImageSize );
    ...
    {
        return $this->_getData( LabelInterface::PRODUCT_POSITION );
    }
    ...
    {
        $this->setData( LabelInterface::PRODUCT_POSITION, $prodPos );
    ...
    {
        return $this->_getData( LabelInterface::PRODUCT_CUSTOM_CSS );
    }
    ...
    {
        $this->setData( LabelInterface::PRODUCT_CUSTOM_CSS, $prodStyle );
    ...
    {
        return $this->_getData( LabelInterface::PRODUCT_TEXT_SIZE );
    }
    ...
    {
        $this->setData( LabelInterface::PRODUCT_TEXT_SIZE, $prodTextStyle );
    ...
    {
        return $this->_getData( LabelInterface::CAT_TYPE );
    }
    ...
    {
        $this->setData( LabelInterface::CAT_TYPE, $catType );
     ...
     * {@inheritdoc}
     */
    public function getCatShape()
    {
        return $this->_getData( LabelInterface::CAT_SHAPE );
    }

    /**
     * {@inheritdoc}
     */
    public function setCatShape( $catShape )
    {
        $this->setData( LabelInterface::CAT_SHAPE, $catShape );
    ...
    {
        return $this->_getData( LabelInterface::CAT_LABEL_TEXT );
    }
    ...
    {
        $this->setData( LabelInterface::CAT_LABEL_TEXT, $catTxt );
    ...
    {
        return $this->_getData( LabelInterface::CAT_POSITION );
    }
    ...
    {
        $this->setData( LabelInterface::CAT_POSITION, $catPos );
    ...
    {
        return $this->_getData( LabelInterface::CAT_CUSTOM_CSS );
    }
    ...
    {
        $this->setData( LabelInterface::CAT_CUSTOM_CSS, $catStyle );
    ...
    {
        return $this->_getData( LabelInterface::CAT_TEXT_SIZE );
    }
    ...
    {
        $this->setData( LabelInterface::CAT_TEXT_SIZE, $catTextStyle );
